...
class KNearestNeighbor(object):
  ...
  def predict_labels(self, dists, k=1):
    ...
    #for i in xrange(40):
      ...
      #########################################################################
      closey = np.argsort(dists[i], axis=0)
      #########################################################################
      # TODO:                                                                 #
      ...
      # label.                                                                #
      #########################################################################
      closest_y =self.y_train[closey[0:k]].tolist()
      #print(sorted(closest_y,key=closest_y.count,reverse=True))
      y_pred[i] = sorted(closest_y,key=closest_y.count,reverse=True)[0]
      #########################################################################
      #                           END OF YOUR CODE                            # 
      #########################################################################
